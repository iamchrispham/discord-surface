...
const COMMAND_FLAGS = Object.freeze({
  ...
  'ordinary-bind': ['channel', 'channel-id', 'workspace', 'session-root', 'native-id', 'guild-id'],
  'ordinary-bind-run': ['channel', 'channel-id', 'workspace', 'session-root', 'native-id', 'guild-id'],
